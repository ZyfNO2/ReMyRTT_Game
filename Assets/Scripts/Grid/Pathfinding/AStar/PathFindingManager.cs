...
public class PathFindingManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (Instance != null)
        {
            Debug.LogError("PathFindingManager" + transform + "-" + Instance );
            Destroy(gameObject);
            return;
        }
        Instance = this;
    ...
    public List<GridPosition> FindPath(GridPosition startGridPosition, GridPosition endGridPosition, out int pathLength)
    {
        ...
        for (int x = 0; x < gridSystem.GetWidth(); x++)
        {
            ...
            {
                GridPosition gridPosition = new GridPosition(x, z);
                PathNode pathNode = gridSystem.GetGridObject(gridPosition).GetPathNode();
    ...
    public int CalculateDistance(GridPosition gridPositionA, GridPosition gridPositionB)
     ...
     {
          return gridSystem.GetGridObject(new GridPosition(x, z)).GetPathNode();
     }
     ...
     {
          return gridSystem.GetGridObject(gridPosition).GetPathNode().IsWalkAble();
     }
     
     
     public void SetIsWalkableGridPosition(GridPosition gridPosition,bool isWalkable)
     {
          gridSystem.GetGridObject(gridPosition).GetPathNode().SetIsWalkable(isWalkable);
     }
